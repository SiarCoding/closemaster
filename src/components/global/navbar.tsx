...
const Navbar = async (props: Props) => {
  return (
    ...
    blackdrop-blur-lg z-[100] flex items-center border-b-[1px]
    border-neutral-900 justify-between">
        ...
        translate-x-[-50%] translate-y-[-50%] hidden md:block">
          <ul className="flex items-center gap-4 list-none">
            ...
            <li>
              <Link href="#">Lösung</Link>
            </li>
            <li>
              <Link href="#">Kundenerfahrungen</Link>
            </li>
            <li>
              <Link href="#">Ressourcen</Link>
            </li>
            <li>
              <Link href="#">Dokumentation</Link>
            </li>
            <li>
